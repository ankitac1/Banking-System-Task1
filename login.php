...
<head>
    ...
    define('bankname', 'The Sparks Foundation Project : TBF Bank');
...
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt; background-color: #5bc55b;"><kbd>Presented by:Ankita Chakraborty</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
